...
```{r, echo=FALSE}
ABIA=read.csv("/Users/liusu/Desktop/ECO395M-master/data/ABIA.csv", header = T)
...
-  For the optimal value of K(15), show a plot of the fitted model--predictions vs. x.
...
p_test + geom_line(aes(x=mileage, y=price_pred), color='red') +
  labs(title = "Predictions under K=12") +
       theme(plot.title=element_text(face="bold", hjust=0.5)) 
...
Because the 350's(416) number of observations is larger than the 65AMG's(292). For a better balance between bias and variance, the 350 with larger observations needs a larger K.
